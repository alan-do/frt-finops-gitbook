...
| environment | string | dev \| staging \| production |
| allocation_rule_id | uuid | Rule đã phân bổ dòng này → ALLOCATION_RULE |
| split_method | string | Cách chia cost |
| split_ratio | decimal | Tỷ lệ cho dòng shared-cost (largest-remainder) |
