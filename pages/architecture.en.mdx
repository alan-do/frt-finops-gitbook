...
* **Frontend:** **Next.js + React** for SSR dashboards and highly responsive UI.
* **AI Gateway:** A centralized proxy service (e.g., LiteLLM) to route requests between OpenAI, Claude, and Gemini, providing fallback mechanisms and prompt logging.
...
stateDiagram-v2
    ...
    Root_Cause_Agent --> Generate_Hypothesis : Query Logs & Metrics
    Generate_Hypothesis --> Auto_Remediation_Agent : Pass Context
    Auto_Remediation_Agent --> Evaluate_Confidence
    Evaluate_Confidence --> Execute_Action : Confidence > 95%
    Evaluate_Confidence --> Human_in_the_Loop : Confidence < 95%
